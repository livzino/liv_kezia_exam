  ...
  return (
    <Link href="/booking">
      <div className="flex justify-center">
        ...
        <div className="vip bg-indigo-800  text-center h-96 lg:h-[500px] xl:h-[500px]  lg:w-96 xl:w-100 whitespace-nowrap  rounded-3xl p-10 text-lg lg:text-2xl xl:text-3xl text-blue-500 grid grid-cols-1 hover:scale-105">
          ...
          <h2 className="font-bold mb-5 tracking-wide text-lime-300 lg:text-2xl xl:text-2xl" style={{ fontFamily: "Syncopate, sans-serif", fontWeight: 700 }}>
            ADGANG ALLE
            <br /> FESTIVALENS DAGE
          </h2>
